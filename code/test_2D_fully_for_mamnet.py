...
def Inference(FLAGS):
   ...
   print("net type:", type(net))  # <--- 加这行
   if net is None:
        raise ValueError("net_factory 返回了 None！检查 model 名和 net_factory.py")
   ...
   print("模型路径是否存在：", os.path.exists(save_mode_path))  # 应该输出 True
...
#/home/gincy/音乐/Mamba-UNet/model/ACDC/Semi_Mamba_UNet_3/mambaunet/mambaunet_best_model1.pth
